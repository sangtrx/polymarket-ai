# Requirements Archive: v1.0 BMAD Coverage Audit

**Archived:** 2026-04-09
**Status:** SHIPPED

Next milestone requirements are created fresh via `/gsd-new-milestone`.
...
- [x] **GATE-01**: User can execute the audit in CI to produce deterministic artifacts for a given commit snapshot
- [x] **GATE-02**: User can receive an advisory deployment-readiness signal derived from audit results
- [x] **GATE-03**: User can manage waivers for unresolved gaps with owner, reason, and expiry metadata

### Reporting & Export

- [x] **RPTG-01**: User can export audit outputs as both human-readable markdown and machine-readable JSON
- [x] **RPTG-02**: User can view a summary report that states coverage posture, top risks, and readiness recommendation

## Milestone Outcome Notes

| Requirement | Milestone outcome |
|-------------|-------------------|
| GATE-01 | Partial in integration audit; accepted as tech debt for next milestone (CI PATH portability hardening). |
| GATE-02 | Satisfied in phase verification; checkbox had been stale before archival. |
| GATE-03 | Satisfied in phase verification; checkbox had been stale before archival. |
| RPTG-01 | Satisfied in phase verification; checkbox had been stale before archival. |
| RPTG-02 | Partial in integration audit; accepted as tech debt for next milestone (markdown parity hardening). |
...
| GATE-01 | Phase 5 | Complete (accepted gap) |
| GATE-02 | Phase 5 | Complete |
| GATE-03 | Phase 5 | Complete |
| RPTG-01 | Phase 5 | Complete |
| RPTG-02 | Phase 5 | Complete (accepted gap) |
