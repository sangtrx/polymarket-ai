...
use domain::research::{
    ...
    CounterfactualReplaySummary, CounterfactualReplayValidationIssue,
    FR46_DEGRADATION_DENY_THRESHOLD_PCT, FR46_DELAYED_EXIT_SECONDS,
    FR46_STRESSED_SLIPPAGE_MULTIPLIER, ShadowEvaluationRecord, ShadowEvaluationState,
    ShadowSimulationDecisionSide, ShadowSimulationOutcome, ValidationWorkflowArtifactRecord,
    ValidationWorkflowRunRecord, ValidationWorkflowRunState,
    canonicalize_counterfactual_replay_run_record, compose_counterfactual_replay_run_id,
    evaluate_counterfactual_replay_gate, fr46_scenario_parameters, normalize_research_identifier,
